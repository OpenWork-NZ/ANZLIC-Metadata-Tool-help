...
1. Simple search
    ...
    * To the right of the desired entry select the appropriate role for the party by clicking either the "Chain link" ![Link icon](/image/linkSelector.png) or "+" ![Add icon](/image/addSelector.png). 
